...
export default function Page() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen min-w-[375px]">
      <main className="w-full min-h-screen grid place-content-stretch grow md:grow-0 md:min-h-100 max-w-5xl md:bg-white md:rounded-xl md:drop-shadow-xl">        
        <div className="[grid-area:1/1] h-full">
          <Image src="/bg-sidebar-mobile.svg" alt="sidebarMobile" width={375} height={172} className="min-w-screen md:hidden"/>
        ...
        <div className="[grid-area:1/1] md:ml-[300px] flex flex-col">
          <div className={`mt-27 mb-10 mx-auto w-[95%] bg-white rounded-xl h-fit pt-8 pb-6 drop-shadow-xl md:w-4/5 md:mb-0 md:drop-shadow-none ${stepNum===5 ? "md:mt-0 content-center h-full px-14" : "md:mt-8 px-7 md:px-2 lg:px-7"}`}>
